...
public class Inventory :MonoBehaviour
{
    ...
    public void ClickItem(int mainIndex)//������ ���? ��ȣ�ۿ� ������ �츮? �ϴ� �صδµ� Ʈ���Ű� ����;;
    {
        _dragItem.SetParent(this.transform.Find("Main Camera"), false);
        _dragItem.localPosition =new Vector3(0,-0.3f,1.7f);
        _dragItem.localRotation = Quaternion.identity;
        InventorySlot[mainIndex].Clears();
        //�ƹ�ư �����صξ��ٰ� �巡�׵� ���� �ű�ٸ� SetItem ȣ���ؼ� �Ǹ� �ű�� �Űܰ��� �ȵǸ� ����
    }
    public bool SetItem(int mainIndex,ItemBase item,bool xy=true) //���� �����̳� �׷��� �ܷε� ȹ�� ��� ������� ����, �ϴ� ��������
    {
    ...
    private bool Check(int mainIndex, ItemBase item,bool xy) //bool xy�� ��� true�� �� false�� �Ӹ��
    {
        if (xy==true)
        {
