...
namespace Utils
{
    public static class GameObjectUtils
    {
        ...
        public static void BindUIEvent(this GameObject go, Action<PointerEventData> action = null, Utils.Defines.UIEventTypes type = Utils.Defines.UIEventTypes.CLICK)
        {
