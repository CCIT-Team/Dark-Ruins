...
namespace AdvancedHorrorFPS
{
	...
	public class FirstPersonController : MonoBehaviour
	{
        ...
        private InputAction crouchLeftAction;
        private InputAction crouchRightAction;
		...
		{
			if(jumpAction.WasReleasedThisFrame() && AdvancedGameManager.Instance.canJump && AdvancedGameManager.Instance.controllerType == ControllerType.PcAndConsole)
            {
				Jump();
			}
			if (((crouchLeftAction.WasReleasedThisFrame() || crouchRightAction.WasReleasedThisFrame()) && AdvancedGameManager.Instance.canCrouch && AdvancedGameManager.Instance.controllerType == ControllerType.PcAndConsole))
			{
				Crouch();
			}
			if (Grounded)
