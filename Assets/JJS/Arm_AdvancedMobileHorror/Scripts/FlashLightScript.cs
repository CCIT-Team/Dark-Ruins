    ...
    public class FlashLightScript : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (AdvancedGameManager.Instance.controllerType == ControllerType.PcAndConsole)
            {
                ...
                if (AdvancedGameManager.Instance.blueUVLightAttack)
                {
                    if (mouseRightAction.WasPressedThisFrame() && AdvancedGameManager.Instance.controllerType == ControllerType.PcAndConsole)
                    {
                        GameCanvas.Instance.FlashLight_BlueEffect_Down();
                    }
                    else if (mouseRightAction.WasReleasedThisFrame() && AdvancedGameManager.Instance.controllerType == ControllerType.PcAndConsole)
                    {
