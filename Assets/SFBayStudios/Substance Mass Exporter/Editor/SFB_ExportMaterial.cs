...
public class SFB_ExportMaterial : ScriptableObject
{
    ...
    public List<SFB_MaterialExports> materials = new List<SFB_MaterialExports>();    // Materials we have selected
    ...
    // ✅ FIX: ProceduralMaterial is obsolete/removed in Unity.
    // Use UnityEngine.Material so the project compiles without Substance support.
    public Material newMaterial;                                                     // For dragging materials into the list
}
