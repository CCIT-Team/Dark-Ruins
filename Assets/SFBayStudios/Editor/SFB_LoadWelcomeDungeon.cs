...
public class Startup {
	...
	{ 
		if (EditorApplication.timeSinceStartup < 10) {
			var loadedCount = EditorPrefs.GetInt("SFB_LoadedCountDungeon");
			EditorPrefs.SetInt("SFB_LoadedCountDungeon", loadedCount + 1);
			Debug.Log ("IMPORTANT:  Please read the \"Read Me\" file in the root of the Dungeon Plus folder!");
			...
			if (EditorPrefs.GetInt("SFB_Welcome2") != 1 && EditorPrefs.GetInt("SFB_LoadedCount2") % 7 == 0 )
			{
				var option = EditorUtility.DisplayDialogComplex(
					"IMPORTANT:  Please read the \"Read Me\" file in the root of the Dungeon Plus folder!\nwww.InfinityPBR.com: Please Register, Review & Rate!",
